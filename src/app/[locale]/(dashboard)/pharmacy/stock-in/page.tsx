...
export default function PharmacyCounteragentsPage() {
  ...
  return (
    <div>
      <Breadcrumb
        breadcrumbs={[{ label: 'Dorixona' }, { label: 'Qoldiq kiritish' }]}
      />
      <Heading4 className=''>{t('Qoldiq kiritish')}</Heading4>
        ...
        <div className='mt-4 space-y-6'>
          ...
          <div className='grid grid-cols-5 gap-4 rounded-lg bg-white p-4'>
            <div className='flex flex-col gap-1'>
              ...
              {/* <AppSelect
                placeholder={t('Mahsulotni tanlang')}
                options={[
                  { value: '1', label: 'Manba 1' },
                  { value: '2', label: 'Manba 2' }
                ]}
            ...
            <div className='flex flex-col gap-1'>
              <AppLabel isRequired text={t('Upakovka soni')} />
              <AppInput />
            </div>
            <div className='flex flex-col gap-1'>
              <AppLabel isRequired text={t('Donasi narxi')} />
              <AppInput placeholder={t('Donasi narxini kiriting')} />
            </div>
      ...
      >
        <div className='my-4 block bg-white p-6'>
          <p className='text-center'>
            {t(
              "Siz ushbu ID:1992 raqamli kiritilgan qoldiqni o'chirib yubormoqchimisiz?"
            )}
          </p>
        </div>
