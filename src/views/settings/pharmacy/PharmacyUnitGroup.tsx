...
export default function PharmacyUnitGroup() {
    ...
    <div className='flex flex-col gap-4'>
      ...
      <Modal title="Qo'shish" open={open} size='lg/2' onClose={handleClose}>
        <div className='mt-4 space-y-6'>
          <div>
            <AppLabel text={t("O'lchov birlik nomi")} isRequired />
            <AppInput
              onChange={e => {
                //
              }}
              placeholder={t("O'lchov birlik nomini kiriting")}
            />
          </div>
      ...
      >
        <div className='my-4 block bg-white p-6'>
          <p className='text-center'>
            {t("Siz ushbu Mm o'lchov birlikni o'chirib yubormoqchimisiz?")}
          </p>
        </div>
